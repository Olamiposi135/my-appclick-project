...
const Footer = () => {
    ...
    return (
        <div>
            <footer className="bg-indigo-900 dark:bg-gray-950 text-white dark:text-gray-100 z-40">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <p className="text-gray-300 dark:text-gray-400 text-sm leading-relaxed mb-4">
                                ...
                                experiences and feedbacks about government
                                grants and schemes. Join our community to stay
